...
| **Commit messages**            | Generates a commit message (or automatically commits with `--with-commit`).         |
...
| **.gitignore Support**         | Respects project `.gitignore` rules and safely skips non-existent files.            |
| **Simple Push**                | Quickly pushes current or specified branch to origin.                               |
